...
class Services(BaseModel):
    ...
    attributes: Optional[List[Union[str, Dict[str, Any], List, bool, float]]] = Field(
        None,
    ...
    open311_metadata: Optional[bool] = Field(
        None,
        alias='open311:metadata',
    ...
    open311_type: Optional[Open311Type] = Field(
        None,
        alias='open311:type',
    ...
    type: Optional[Type6] = Field(
        None, description="NGSI Entity type. It has to be services. Enum:'services'"
    )
