...
attributes = [{'code': 'ISSUE_TYPE', 'datatype': 'singlevaluelist', 'datatype_description': '', 'description': 'What is the identified problem at the sidewalk?', 'order': 1, 'required': True, 'values': [{'key': 123, 'name': 'Bump'}, {'key': 124, 'name': 'Dirty'}], 'variable': True}]
