...
dataModel = "IssueReporting"
subject = "dataModel.IssueTracking"
category = "{'type': 'Property', 'value': 'Maintenance'}"
attribute = "category"
value = category
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

categoryCode = "{'type': 'Property', 'value': '112'}"
attribute = "categoryCode"
value = categoryCode
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

comments = "{'type': 'Property', 'value': 'Road not in proper condition'}"
attribute = "comments"
value = comments
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

departmentId = "{'type': 'Property', 'value': '12'}"
