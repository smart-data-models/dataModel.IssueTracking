...
Open311_ServiceRequest:    
  ...
  type: object    
```  
Aquí hay un ejemplo de un Open311_ServiceRequest en formato JSON como valores clave. Esto es compatible con NGSI V2 cuando se utiliza `opciones=valores-clave` y devuelve los datos de contexto de una entidad individual.  
...
```  
Aquí hay un ejemplo de un Open311_ServiceRequest en formato JSON como normalizado. Esto es compatible con NGSI V2 cuando se utiliza `opciones=valores clave` y devuelve los datos de contexto de una entidad individual.  
...
```  
Aquí hay un ejemplo de un Open311_ServiceRequest en formato JSON-LD como valores clave. Esto es compatible con NGSI-LD cuando no se usan opciones y devuelve los datos de contexto de una entidad individual.  
